...
public class BlockyBubbles implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        FabricLoader.getInstance().getModContainer(MOD_ID).ifPresent(modContainer ->
            ResourceManagerHelper.registerBuiltinResourcePack(new Identifier(MOD_ID, "32x_upscale"), modContainer, Text.translatable("resourcePack.blocky-bubbles:32x_upscale.name"), ResourcePackActivationType.NORMAL)
        );
